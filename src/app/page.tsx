...
const Card: React.FC<CardProps> = ({
  ...
  return (
    <CardContainer className="inter-var mb-16">
...
const cardData: CardProps[] = [
  {
    ...
    secondaryAction: "Get Started Now",
  },
  {
    title: "Professional",
    price: "$29",
    ...
    primaryAction: "Try Pro →",
    secondaryAction: "Upgrade Now",
  },
  {
    title: "Enterprise",
    price: "$99",
    description:
      "Get a tailored solution for your organization with dedicated support.",
    features: [
      "Custom automations",
